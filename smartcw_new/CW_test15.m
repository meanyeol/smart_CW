function[test_lolp, test_cml,DR, num]=CW_test15(state)
...
%DR : demand response being activated or not
%Let the initial node value==0.
a=0; b=0; c=0; d=0; e=0; f=0;DR=0;
reduction=0.025+0.05*rand;
...
if total_load>10000 && ~(state(1)&&state(2))
    %consider all loads respond
    %total_load=connect*state(9)-reduction*connect;
    total_load=connect*state(9)-reduction*9900*1.15;
    DR=1;
