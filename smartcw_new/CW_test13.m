function[test_lolp, test_cml, num]=CW_test13(state)
%state 1 2 10:transformer state:   3(a)      4(b)       5(c)     6(d)      7(e)     8(f)  feeder  state 9: load
...
if state(1)==1 || state(2)==1 || state(10)==1
...
if total_load>10000 && (state(1)+state(2)+state(10)==1)
    a=0; b=0; c=0; d=0; e=0; f=0;
end
